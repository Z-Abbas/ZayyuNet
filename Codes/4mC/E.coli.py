...
def funciton(PositiveCSV, NegativeCSV, OutputDir, folds):
    ...
    for test_index in range(folds):
        ...
        np.save('/home/zeeshan/SNNRice6mA-master/2nd/4mc/Output_Coli/chunk_folds/'+str(test_index)+'_'+'x_test',test_X)
        np.save('/home/zeeshan/SNNRice6mA-master/2nd/4mc/Output_Coli/chunk_folds/'+str(test_index)+'_'+'y_test',test_y)
        np.save('/home/zeeshan/SNNRice6mA-master/2nd/4mc/Output_Coli/chunk_folds/'+str(test_index)+'_'+'valid_X',valid_X)
        np.save('/home/zeeshan/SNNRice6mA-master/2nd/4mc/Output_Coli/chunk_folds/'+str(test_index)+'_'+'valid_y',valid_y)
        np.save('/home/zeeshan/SNNRice6mA-master/2nd/4mc/Output_Coli/chunk_folds/'+str(test_index)+'_'+'x_train',train_X)
        np.save('/home/zeeshan/SNNRice6mA-master/2nd/4mc/Output_Coli/chunk_folds/'+str(test_index)+'_'+'y_train',train_y)
...
PositiveCSV = 'E.coli_4mc_pos_lab.txt'
NegativeCSV = 'E.coli_4mc_neg_lab.txt'

OutputDir = '/home/zeeshan/SNNRice6mA-master/2nd/4mc/Output_Coli/'
