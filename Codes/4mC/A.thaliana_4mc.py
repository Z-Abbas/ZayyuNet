...
def spinal_cnn():
    ...
    conv4 = Conv1D(filters=64, kernel_size=5,strides=1)(act0)
    ...
    a1 = keras.layers.Lambda(lambda comb: comb[:,0:1024], output_shape=(1024,))(comb)
    a2 = keras.layers.Lambda(lambda comb: comb[:,1024:], output_shape=(1024,))(comb)
...
def funciton(PositiveCSV, NegativeCSV, OutputDir, folds):
    ...
    for test_index in range(folds):
        ...
        np.save('/home/zeeshan/SNNRice6mA-master/2nd/4mc/Output_Thaliana_4mc/chunk_folds/'+str(test_index)+'_'+'x_test',test_X)
        np.save('/home/zeeshan/SNNRice6mA-master/2nd/4mc/Output_Thaliana_4mc/chunk_folds/'+str(test_index)+'_'+'y_test',test_y)
        np.save('/home/zeeshan/SNNRice6mA-master/2nd/4mc/Output_Thaliana_4mc/chunk_folds/'+str(test_index)+'_'+'valid_X',valid_X)
        np.save('/home/zeeshan/SNNRice6mA-master/2nd/4mc/Output_Thaliana_4mc/chunk_folds/'+str(test_index)+'_'+'valid_y',valid_y)
        np.save('/home/zeeshan/SNNRice6mA-master/2nd/4mc/Output_Thaliana_4mc/chunk_folds/'+str(test_index)+'_'+'x_train',train_X)
        np.save('/home/zeeshan/SNNRice6mA-master/2nd/4mc/Output_Thaliana_4mc/chunk_folds/'+str(test_index)+'_'+'y_train',train_y)
...
PositiveCSV = 'A.thaliana_4mc_pos_lab.txt'
NegativeCSV = 'A.thaliana_4mc_neg_lab.txt'

OutputDir = '/home/zeeshan/SNNRice6mA-master/2nd/4mc/Output_Thaliana_4mc/'
