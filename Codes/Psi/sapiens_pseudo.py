...
def spinal_cnn():
    ...
    dropoutLayer1 = Dropout(0.50)(pool2)
    ...
    dropoutLayer2 = Dropout(0.50)(pool4)
    ...
    a1 = keras.layers.Lambda(lambda comb: comb[:,0:576], output_shape=(576,))(comb)
    a2 = keras.layers.Lambda(lambda comb: comb[:,576:], output_shape=(576,))(comb)
...
def funciton(PositiveCSV, NegativeCSV, OutputDir, folds):
    ...
    for test_index in range(folds):
        ...
        np.save('/home/zeeshan/SNNRice6mA-master/2nd/Pseudo/Output_Sapiens_Pseudo/chunk_folds/'+str(test_index)+'_'+'x_test',test_X)
        np.save('/home/zeeshan/SNNRice6mA-master/2nd/Pseudo/Output_Sapiens_Pseudo/chunk_folds/'+str(test_index)+'_'+'y_test',test_y)
        np.save('/home/zeeshan/SNNRice6mA-master/2nd/Pseudo/Output_Sapiens_Pseudo/chunk_folds/'+str(test_index)+'_'+'valid_X',valid_X)
        np.save('/home/zeeshan/SNNRice6mA-master/2nd/Pseudo/Output_Sapiens_Pseudo/chunk_folds/'+str(test_index)+'_'+'valid_y',valid_y)
        np.save('/home/zeeshan/SNNRice6mA-master/2nd/Pseudo/Output_Sapiens_Pseudo/chunk_folds/'+str(test_index)+'_'+'x_train',train_X)
        np.save('/home/zeeshan/SNNRice6mA-master/2nd/Pseudo/Output_Sapiens_Pseudo/chunk_folds/'+str(test_index)+'_'+'y_train',train_y)
        ...
        history = model.fit(train_X, train_y, batch_size = 48, epochs = 60, validation_data = (valid_X, valid_y),callbacks = cbacks);
...
PositiveCSV = 'sapiens_pseudo_pos_lab.txt'
NegativeCSV = 'sapiens_pseudo_neg_lab.txt'

OutputDir = '/home/zeeshan/SNNRice6mA-master/2nd/Pseudo/Output_Sapiens_Pseudo/'
